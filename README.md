...
A browser-side plugin for OpenClaw Control UI. Safe to install — it only modifies your local browser UI and sends no data to external servers. Try it risk-frei!
